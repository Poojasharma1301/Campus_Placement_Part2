...
def predict():
    if request.method == 'POST':
        ...
        print("Donne")
        prediction = model.predict([[gender,ssc_p,hsc_p,degree_p,mba_p,specialisation,workex,hsc_commerce,hsc_art,hsc_science,degree_t_st,degree_t_cm,degree_t_o]])
        print("Done")
        if prediction==1:
             return render_template('index.html',prediction_text="Congratulations You have high chances of getting Placed!")
        else:
             return render_template('index.html',prediction_text="You need to develop Yourself!")
